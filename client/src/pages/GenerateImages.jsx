...
const GenerateImages = () => {
  ...
  //publishing generates img in public or not
...
' action="">
          ...
          <textarea onChange={(e) => setInput(e.target.value)} value={input} rows={4} placeholder='Describe what you want to see in the image...' className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border border-gray-300' required />
